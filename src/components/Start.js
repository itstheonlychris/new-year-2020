...
export class Start extends Component {
	render() {
		...
		return (
			<div>
				<div className='mt-10'>
					<h1 className='leading-none text-5xl lg:text-6xl font-bold text-red-600 my-12 md:my-24 lg:my-32'>
						How long will you keep your resolutions this year?
					</h1>
				</div>
				<div className='my-5 text-teal-800 text-xl md: text-2xl lg:text-3xl md:pr-12 lg:mr-16'>
				...
				<div className='my-16'>
					<button className='group bg-orange-100 border-4 border-red-600 hover:border-red-700 py-2 px-12 text-xl font-bold text-red-600 hover:bg-red-600 hover:text-orange-100 relative' onClick={(e) => {
                        e.preventDefault()
                        this.props.nextStep()}}>
						Try it out!
